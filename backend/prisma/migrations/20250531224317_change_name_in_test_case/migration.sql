/*
  ...
  - You are about to drop the column `passsed` on the `TestCaseResult` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "TestCaseResult" DROP COLUMN "passsed",
